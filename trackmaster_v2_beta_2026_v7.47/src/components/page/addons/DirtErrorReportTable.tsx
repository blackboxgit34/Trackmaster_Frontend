        ...
        <div className="flex items-center gap-2 flex-wrap justify-start sm:justify-end">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={() => handleSort('dirtCount')}>
                Dirt Count {sortConfig.key === 'dirtCount' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
              </DropdownMenuItem>
          ...
          {paginatedData.length === 0 && (
            <div className="flex items-center justify-center py-16 text-muted-foreground">
              <div className="text-center">
                ...
                <p className="text-lg font-medium">No dirt error records found</p>
              ...
              <div key={row.id} className="group">
                ...
                <div
                  className={cn(
                    ...
                    "hover:shadow-md hover:border-amber-200 dark:hover:border-amber-800/50",
                    isExpanded
                      ? "border-amber-200 dark:border-amber-800/50 shadow-md rounded-b-none"
                      : "shadow-sm"
                  )}
                >
                  {/* Left accent border */}
                  <div
                    className={cn(
                      ...
                      isExpanded
                        ...
                        : "bg-gradient-to-b from-slate-300 to-slate-400 dark:from-slate-600 dark:to-slate-700 group-hover:from-amber-400 group-hover:to-amber-500"
                    )}
                  />
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isExpanded
                          ...
                          : "text-muted-foreground hover:text-amber-700 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-950/40"
                      )}
                    >
                ...
                >
                  <div className="border border-t-0 border-amber-200 dark:border-amber-800/50 rounded-b-xl bg-muted/30">
                            ...
                            <div className="flex items-center gap-3">
                              <div>
                                <h5 className="text-base font-semibold text-foreground">
                                  Dirt Error Log: {row.vehicleName}
                                </h5>
                        ...
                        <ScrollArea className="h-[280px] pr-4 mt-2">
                          {sortedDetails.length > 0 ? (
                              ...
                              {sortedDetails.map((detail, idx) => {
                                ...
                                return (
                                  <div key={detail.id} className="relative">
                                    ...
                                    {/* Timeline Dot */}
                                    <div className="absolute -left-[20px] top-1/2 -translate-y-1/2 w-3 h-3 bg-white dark:bg-slate-900 border-2 border-amber-500 rounded-full z-10 shadow-sm"></div>

                                    {/* Timeline Card */}
                                    <div className="bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 rounded-xl shadow-sm hover:border-amber-400 dark:hover:border-amber-500/50 transition-colors py-3 px-4">
                                      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
                                        ...
                                        <div className="lg:col-span-3 text-right flex flex-col justify-center border-t lg:border-t-0 lg:border-l border-slate-200 dark:border-slate-700 pt-3 lg:pt-0 lg:pl-4">
                                          <div className="flex justify-end">
                                            {isOngoing ? (
                                              <span className="w-24 inline-flex justify-center items-center gap-1.5 px-2.5 py-1.5 text-xs font-semibold rounded-full bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300">
                                                <AlertTriangle className="h-3.5 w-3.5" /> Dirt
                                              </span>
                                            ) : (
                                              <span className="w-24 inline-flex justify-center items-center gap-1.5 px-2.5 py-1.5 text-xs font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300">
                            ...
                            <div className="flex flex-col items-center justify-center h-full text-center p-8 mt-4">
                              ...
                              <p className="text-sm text-muted-foreground font-medium">No dirt error details available for this day.</p>
                            </div>
                          )}
                        </ScrollArea>
                      </div>
