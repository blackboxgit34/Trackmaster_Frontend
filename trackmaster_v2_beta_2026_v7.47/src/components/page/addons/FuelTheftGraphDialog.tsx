...
interface FuelTheftGraphDialogProps {
  open: boolean;
...
const FuelTheftGraphDialog = ({ open, onOpenChange, graphData, vehicleName, date }: FuelTheftGraphDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[70vh]">
        <DialogHeader>
          <DialogTitle>Fuel Theft Graph: {vehicleName}</DialogTitle>
          <DialogDescription>
...
export default FuelTheftGraphDialog;